...
status: Accepted, amended by ADR-0021 and ADR-0024
date: 2026-08-19
...
[ADR-0024](0024-grace-advances-only-on-real-recheck.md) removed the two notifications that only a
timer over verified domains could have sent.
