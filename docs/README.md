...
| [`decisions/`](domain-ownership/decisions/) | ADR-0001 to ADR-0023 — one decision per file, with the alternatives rejected and why. **The source of truth**: when the PRD and an ADR disagree, the ADR wins |
...
| `milestones/` | Implementation milestones. Empty until Section 4 of the PRD is written |
