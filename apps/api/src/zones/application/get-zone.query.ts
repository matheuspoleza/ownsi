...
export type ZoneStep =
  | { readonly type: "failed"; readonly error: GetZoneError }
  | {
...
export type GetZone = (input: GetZoneInput) => AsyncGenerator<ZoneStep, void>

export type GetZoneDeps = {
...
export function getZone(deps: GetZoneDeps): GetZone {
...
function failed(error: GetZoneError): ZoneStep {
